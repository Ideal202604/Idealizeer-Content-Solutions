            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  <div className="text-4xl font-heading font-bold text-white">10+</div>
              ...
              {REASONS.map((reason, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-lg font-heading font-bold text-white mb-2 leading-7">
                        {reason.title}
                      </h4>
                      <p className="text-sm md:text-base text-slate-700 dark:text-slate-400 leading-7">
                        {reason.description}
                      </p>
                    </div>
                  </motion.div>
